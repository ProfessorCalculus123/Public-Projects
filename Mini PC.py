...
def chat_bot():
    ...
    def transaltions():
        ...
        calculator_requests = [
            ...
            "Is it okay if I use a calculator?",
            "Can I grab the calculator?",
            "Mind if I use the calculator?",
            "Could you pass me the calculator?",
            "Can I calculate this real quick?",
            "Do you have a moment to use the calculator?",
            "I need to use a calculator, is that fine?",
            "Would you mind if I used the calculator?",
            "Could I borrow the calculator?",
            "Can I use the calculator for a second?",
            "I need to do some math, can I use the calculator?",
            "Is it alright if I use the calculator now?",
            "Can I use your calculator?",
            "Let's calculate something!",
            "Let's use the calculator for a quick calculation.",
            "How about we calculate this together?",
            "Let's figure this out using the calculator.",
            "Can we do some math with the calculator?",
            "Let's solve this using a calculator.",
            "I need to calculate something, let's use the calculator.",
            "Let's do a quick calculation!",
            "I think we need a calculator for this.",
            ...
            "can you solve this",
            "let's calculate something",
            "can you use a calculator for me",
...
def grad_calculators():
    def weighted_calc():
        ...
        if (
            exit_choice.lower() == "y"
            or exit_choice.lower() == "yes"
            or exit_choice.lower() == ""
        ):
            weighted_calc()
    ...
    def grade_goal():
        ...
        print(
            "You need to achieve "
            + required_final_grade
            + " to achieve a final grade of "
            + goal
        )
        exit_choice = input("Start Again: ")
        if (
    ...
    def gpa_goal():
        ...
        if result_final > 4:
            ...
            print(
                "You need a GPA of "
                + result_final1
                + " on average for the next "
                + time_goal1
                + " semesters to achieve a GPA of "
                + goal_gpa1
            )
        exit_choice = input("Start Again: ")
        if (
...
def games():
    ...
    def RLGL():
        ...
        def rules():
            ...
            print("Game Modes:")
            print(
                "1. Classic: You have 120 seconds to get to the other side without being caught during the red light phase."
            )
            ...
            print(
                "5.Bloodbath: Twice the length, twice  the danger and twice the difficulty\n "
            )
...
def YT_Analytics():
    ...
    def YT_Title_Gen():
        ...
        while index < num:
            ...
            if hows == "y":
                title = (
                    "How to make A " + keyword + " " + enter_keyword + " in Minecraft"
                )
            else:
                title = (
                    "You need this " + keyword + " " + enter_keyword + " in Minecraft"
                )
            print(title)
            index += 1
        exit_choice = input("Start Again: ")
    ...
    def Trend_Calculator():
        ...
        if vidiq > raw_score:
            accuracy = round(
                final_score / vidiq * 100
            )  # This should be positive (raw_score is higher)
        else:
            accuracy = round(
                vidiq / final_score * 100
            )  # This should also be positive (vidiq is higher)
    ...
    def YT_Grade():
        ...
        total_grade_num = (
            views_grade_num + likes_grade_num + eng_grade_num + com_grade_num
        ) / 4
        if bonus > 3:
            bonus = 3
